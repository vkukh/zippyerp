...
use App\Entity\Doc\CashReceiptIn as CRIN;
 ...
 */
class CashReceiptIn extends \App\Pages\Base
{
    ...
    public function __construct($docid = 0) {
        ...
        $this->docform->add(new DropDownChoice('optype', CRIN::getTypes(), H::TYPEOP_CUSTOMER_IN))->onChange($this, 'optypeOnChange');
    ...
    public function optypeOnChange($sender) {
        ...
        if ($optype == H::TYPEOP_RET_IN) {
            $this->docform->lblopdetail->setText('Магазин');
        }
    ...
    public function opdetailOnAutocomplete($sender) {
        ...
        if ($optype == H::TYPEOP_RET_IN) {
            return Store::findArray('storename', "storename like '%{$text}%'   ");
        }
        return array();
    }
