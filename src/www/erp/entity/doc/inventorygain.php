...
class InventoryGain extends Document
{
    ...
    public function Execute()
    {
        ...
        foreach ($this->detaildata as $item) {
            ...
            $sc = new SubConto($this, $item['type'], $item['partion'] * ($item['quantity'] / 1000));
        ...
        foreach ($types as $acc => $value) {
            Entry::AddEntry($acc, $this->headerdata["gains"], $value['amount'], $this->document_id, $this->document_date);
        }
