...
class Stock extends \ZCL\DB\Entity
{
         ...
         */
        public function updateStock($qty, $price, $document_id, $serials = array())
        {
                $user_id = \ZippyERP\System\System::getUser()->getUserID();
                $conn = \ZCL\DB\DB::getConnect();
                $sql = "insert  into erp_stock_activity (stock_id,user_id,document_id,qty,price) values ( {$this->stock_id},{$user_id},{$document_id},{$qty},{$price} )";
                $conn->Execute($sql);
