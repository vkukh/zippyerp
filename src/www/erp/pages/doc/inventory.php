...
class Inventory extends \ZippyERP\System\Pages\Base
{
    ...
    public function __construct($docid = 0)
    {
        ...
        $this->docform->add(new DropDownChoice('itemtype', array(201 => 'Материал', 25 => 'Полуфабрикат', 281 => 'Товар'), 201))->setChangeHandler($this, "OnItemType");
        ...
        $this->docform->add(new SubmitLink('load'))->setClickHandler($this, 'loadOnClick');
    ...
    public function OnAutoItem($sender)
    {
        ...
        return Stock::findArrayEx("store_id={$store_id} and closed <> 1 and  itemname  like '%{$text}%' and stock_id in(select stock_id  from  erp_account_subconto  where  account_id= {$account_id}) ");
    }
