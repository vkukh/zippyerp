...
/**
 * Страница  спиание  ТМЦ (затраты)
 */
class InventoryExpence extends \ZippyERP\System\Pages\Base
{
    ...
    public function __construct($docid = 0)
    {
        ...
        $this->editdetail->add(new DropDownChoice('edittype', array(201 => 'Материал', 25 => 'Полуфабрикат'), 201))->setChangeHandler($this, "OnItemType");
        ...
        if ($docid > 0) {    //загружаем   содержимок  документа на страницу
            ...
            $this->_doc = Document::create('InventoryExpence');
