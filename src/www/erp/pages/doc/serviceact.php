...
class ServiceAct extends \ZippyERP\ERP\Pages\Base
{
    ...
    public function __construct($docid = 0, $basedocid = 0)
    {
        ...
        $this->editdetail->add(new DropDownChoice('edititem', Item::findArray('itemname', 'item_type=' . Item::ITEM_TYPE_SERVICE)))->setAjaxChangeHandler($this, 'OnItem');
