...
class ServiceAct extends \ZippyERP\ERP\Pages\Base
{
            ...
            if ($basedocid > 0) {  //создание на  основании
                ...
                if ($basedoc instanceof Document) {
                    ...
                    if ($basedoc->meta_name == 'Invoice') {
                        ...
                        $this->docform->ccard->setChecked($basedoc->headerdata['ccard']);
                        $this->docform->cash->setChecked($basedoc->headerdata['cash']);
    ...
    public function OnAutoCustomer($sender) {
        ...
        return Customer::findArray("customer_name", " (cust_type=" . Customer::TYPE_FIRM . "  or cust_type=" . Customer::TYPE_CLIENT . ")  and customer_name like " . $text);
    }
    ...
    public function OnAutoItem($sender) {
        ...
        return Item::findArray("itemname", "  deleted <> 1 and itemname like {$text}  and   item_type =" . Item::ITEM_TYPE_SERVICE);
    }
