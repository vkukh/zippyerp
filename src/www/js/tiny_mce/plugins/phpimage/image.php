...
//	$handle->Process($server_image_directory);
   //leon
        ...
        else
        {
           ...
           // echo "-----------".$server_image_directory."/".$_FILES['image_field']['name'];
          move_uploaded_file($_FILES['image_field']['tmp_name'], $server_image_directory."/".$_FILES['image_field']['name']);
            echo "<script>setTimeout(\"document.getElementById('src').value='".$url_image_directory."/".$_FILES['image_field']['name']."'\", 200)</script>";
