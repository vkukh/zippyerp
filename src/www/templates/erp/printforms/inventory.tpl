        ...
        <table class="ctable" border="0" cellspacing="0" cellpadding="2">
            ...
            <tr>
                <td style="font-weight: bolder;font-size: larger;" align="center" colspan="7" valign="middle">
                    <br><br>Інвентаризація № {{document_number}} від {{date}} <br><br>
                </td>
            </tr>
            <tr>
            ...
            <tr style="font-weight: bolder;">
                ...
                <th style="border-top:1px #000 solid;border-bottom:1px #000 solid;" width="50">Факт</th>
            ...
            <tr>
                ...
                <td align="right">{{realquantity}}</td>
