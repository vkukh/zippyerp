...
<table class="ctable" border="0" cellspacing="0" cellpadding="2">
    ...
    <tr style="font-weight: bolder;">
        ...
        <th colspan="2"   style="border-top:1px #000 solid;border-bottom:1px #000 solid;">ФИО</th>
        ...
        <th style="border-top:1px #000 solid;border-bottom:1px #000 solid;" width="80">Выплата</th>
    </tr>
    {{#_detail}}
    <tr>
    ...
    <tr style="font-weight: bolder;">
        ...
        <td style="border-top:1px #000 solid; " align="right">Всего:</td>
