...
<table class="ctable" border="0" cellspacing="0" cellpadding="2">
    ...
    <tr>
        <td></td>
        <td>К оплате</td>
        <td colspan="6">{{paydate}}</td>
    </tr>

    <tr>
        <td style="font-weight: bolder;font-size: larger;" align="center" colspan="7" valign="middle">
            <br><br> Счет № {{document_number}} от {{date}} <br><br><br>
        </td>
    </tr>
    ...
    <tr style="font-weight: bolder;">
        ...
        {{#usends}}       <th align="right" style="border-top:1px #000 solid;border-bottom:1px #000 solid;" width="100">Цена с  НДС</th>{{/usends}}
