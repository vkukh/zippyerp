...
class Item extends \ZCL\DB\Entity
{
    ...
    protected function init() {
        $this->item_id = 0;
        $this->item_type = 0; //0- ТМЦ,1 - ОС и НМА
        $this->cat_id = 0;
        $this->curname = '';
        $this->currate = 0;
        $this->price = 0;
    ...
    /**
     * Возвращает  список синтетических счетов на которых млгут
     * быть ТМЦ.
     * 
     */
    public static function getAccounts() {
        $list = array();
        $list['201'] = 'Сировина й матеріали';
        $list['22'] = 'МШП';
        $list['25'] = 'Напiвфабрикати';
        $list['26'] = 'Готова продукція';
        $list['281'] = 'Товари на складі';
        $list['282'] = 'Товари в торгівлі';
