...
/**
 * Страница  ввода   списание  ТМЦ
 */
class ItemExpence extends \App\Pages\Base
{
    ...
    public function __construct($docid = 0, $basedocid = 0) {
        ...
        $this->docform->add(new DropDownChoice('types', array('23' => 'Производство', '91' => 'Общепроизводственные расходы', '92' => 'Административные расходы', '93' => 'Расходы на сбыт'), 23));
        ...
        if ($docid > 0) {    //загружаем   содержимое  документа на страницу
            ...
            $this->docform->types->setValue($this->_doc->headerdata['types']);
            ...
            $this->_doc = Document::create('ItemExpence');
    ...
    public function savedocOnClick($sender) {
        ...
        $this->_doc->headerdata = array(
            ...
            'types' => $this->docform->types->getValue(),
    ...
    public function OnAutoItem($sender) {
        ...
        return Stock::findArrayEx("store_id={$store_id} and  acc_code in ('201','203','207')   and (itemname like {$text} or item_code like {$text}) ");
    }
