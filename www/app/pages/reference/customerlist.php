...
class CustomerList extends \App\Pages\Base
{
    ...
    public function __construct() {
        ...
        $this->customerdetail->add(new CheckBox('editnds'));
        ...
        $this->customerdetail->add(new DropDownChoice('editbank', \App\Entity\Bank::findArray('bank_name', '', 'bank_name')));
    ...
    public function editOnClick($sender) {
        ...
        $this->customerdetail->editnds->setChecked($this->_customer->nds);
    ...
    public function saveOnClick($sender) {
        ...
        $this->_customer->nds = $this->customerdetail->editnds->isChecked() ? 1 : 0;
